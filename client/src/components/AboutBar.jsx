        ...
        <div className="relative max-w-7xl w-full flex flex-col md:flex-row md:h-[450px] bg-black rounded-[2rem] md:rounded-[3rem] shadow-2xl">
          <div className="w-full md:w-[40%] lg:w-[35%] py-8 md:py-12 px-4 md:pl-8 md:pr-4 relative z-20 flex flex-col justify-center">
            <div className="relative">
              <div className="absolute left-0 w-full md:w-[105%] lg:w-[97%] h-16 md:h-20 bg-teal-500 rounded-[1.5rem] md:rounded-full transition-transform duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] flex items-center justify-end pr-2 shadow-2xl" style={{ transform: `translateY(${activeTab * (window.innerWidth >= 768 ? 80 : 64)}px)` }} >
