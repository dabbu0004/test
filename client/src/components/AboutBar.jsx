...
const tabData = [
  ...
  { 
    title: "Growth", 
    text: "Accelerate your business h our growth  engines.Accelerate your business with our growth engines.Accelerate your business wwith our growth engines.", 
    percent: 92, 
  ...
  { 
   ...
   { 
    title: "Security", 
    text: "Enterprise-grade security  for your business with our growth engines.Accelerate your business with our growth engines.Accelerate your business with our growth engines.Accelerate your business with our growth engines.for your peace of mind. jre er er re er re re re er er re re re re re re re rer e erre re re re er", 
    percent: 99, 
    points: ["End-to-end encryption", "End-to-end encryption" , "End-to-end encryption", "End-to-end encryption", "End-to-end encryption", "End-to-end encryption", "24/7 Monitoring"] 
  },
];
        ...
        <div className="relative max-w-7xl w-full flex flex-col md:flex-row md:h-[450px] bg-black rounded-[2rem] md:rounded-[3rem] shadow-2xl">
          <div className="w-full md:w-[40%] lg:w-[35%] py-8 md:py-12 px-4 md:pl-8 md:pr-4 relative z-20 flex flex-col justify-center">
            <div className="relative">
              <div  className="absolute left-0 w-full md:w-[105%] lg:w-[97%] h-16 md:h-20 bg-teal-500 rounded-[1.5rem] md:rounded-full transition-transform duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] flex items-center justify-end pr-2 shadow-2xl" style={{ transform: `translateY(${activeTab * (typeof window !== "undefined" && window.innerWidth >= 768 ? 80 : 64)}px)` }} >
          ...
          <div className="w-full md:w-[65%] lg:w-[70%] bg-white rounded-[2rem] md:rounded-[3rem] shadow-xl p-6 md:p-8 lg:p-12 md:absolute right-0 top-0 md:h-full z-10 flex flex-col lg:flex-row gap-6 lg:gap-8 items-center border border-gray-100 md:border-none mt-4 md:mt-0">
            <div ref={contentRef} className="flex-1 w-full flex flex-col max-h-[100%]">
              <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-3 md:mb-4 flex-shrink-0"> {tabData[activeTab].title} </h2>
              <div className="flex-1 overflow-y-auto pr-3 max-h-[250px] md:max-h-[280px] lg:max-h-[320px] [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-teal-400 [&::-webkit-scrollbar-thumb]:rounded-full">
                <p className="text-gray-600 text-base md:text-lg leading-relaxed"> {tabData[activeTab].text} </p>
                <div className="mt-4 md:mt-5 flex flex-wrap gap-y-2 md:gap-y-3 gap-x-4 md:gap-x-6 pb-2">
